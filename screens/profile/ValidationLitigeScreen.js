...
const ValidationLitigeScreen = (props) => {

    return (
        <View style={styles.container}>
            <AntDesign name="checkcircleo" size={200} color="white" />
            <Text style={styles.text}>Vous litige a bien été signalé ! Nous reviendrons vers vous très prochainement !</Text>
...
export default ValidationLitigeScreen;
