...
const ValidationIBANScreen = (props) => {

    return (
        <View style={styles.container}>
            <AntDesign name="checkcircleo" size={200} color="white" />
            <Text style={styles.text}>Nous avons bien reçu votre demande ! Votre argent vous sera viré sous 48h !</Text>
...
export default ValidationIBANScreen;
