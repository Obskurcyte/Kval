...
const SupressionMessageValidationScreen = (props) => {

    return (
        <View style={styles.container}>
            <AntDesign name="checkcircleo" size={200} color="white" />
            <Text style={styles.text}>Votre message a bien été supprimé ! </Text>
...
export default SupressionMessageValidationScreen;
